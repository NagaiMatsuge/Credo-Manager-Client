<template>
  <div class="task">
    ...
    <div class="task__card" v-for="(item , index) in tasks" :key="index">
      <div class="task__card-body" >
        ...
        <div class="task__body" :class="{active: item.active}">
          <div class="task__body-title">Сейчас в работе</div>
          <div class="task__body-worked" :class="{active: !item.hide}">
            ...
            <div class="task__body-work-name">
              <p :class="{active: !item.hide}">Нарисовать баннер</p>
              <span v-if="item.hide">Онлайн магазин игрушек</span>
            </div>
            <div class="task__body-time">
              <span :class="{active: !item.hide}">10:57</span>
              <div v-if="item.hide">
                <button>
          ...
          <div class="task__body-not-worked" @click="item.active = !item.active">
            <svg width="20" height="20" viewBox="0 0 20 20" fill="none" xmlns="http://www.w3.org/2000/svg">
          ...
          <div class="task__body-worked pause" v-if="item.active" :class="{active: item.active}">
            <div class="task__body-pause">
              <svg width="20" height="20" viewBox="0 0 20 20" fill="none" xmlns="http://www.w3.org/2000/svg">
            ...
            <div class="task__body-work-name">
              <p>Нарисовать баннер для магазина</p>
              <span>Онлайн магазин игрушек</span>
            </div>
            <div class="task__body-time">
              <span>10:57</span>
              <div>
