<template>
  <div class="user__add">
    <div class="user__add-info">
      <div class="user__add-info-form">
        ...
        <form @submit.prevent="submitHandler">
          ...
          <div class="user__add-group">
            <input type="text" placeholder="Телефонный номер" v-model="phone">
          </div>
          <div class="user__add-group">
            <input :type="type" placeholder="Пароль" v-model="password">
          ...
          <div class="user__add-group">
            <select v-if="roles" v-model="role" value="0">
      ...
      <div class="user__add-workDays-form">
        ...
        <form @submit.prevent="submitHandler">
          <div class="user__add-group">
            ...
            <vue-timepicker :minute-interval="5" v-model="work_start_time" placeholder="Начало работы"></vue-timepicker>
          </div>

          <div class="user__add-group">
            <label>Завершение работы</label>
            <vue-timepicker :minute-interval="5" v-model="work_end_time" placeholder="Завершение работы"></vue-timepicker>
          </div>

          <div class="user__add-group">
            <label>Начало перерыва</label>
            <vue-timepicker :minute-interval="5" v-model="pause_start_time" placeholder="Начало перерыва"></vue-timepicker>
          </div>

          <div class="user__add-group">
            <label>Завершение перерыва</label>
            <vue-timepicker :minute-interval="5" v-model="pause_end_time" placeholder="Завершение перерыва"></vue-timepicker>
          </div>
    ...
    <div class="user__add-submit">
      ...
      <button class="add" type="submit">Создать</button>
    </div>
  </div>
</template>
<script>
...
export default {
  ...
  methods: {
    submitHandler() {
      ...
      this.$store.dispatch('createUserCredentials', formData)
    }
  },
  computed:{
    roles(){
