  ...
  <div class="chat">
    <div class="chat__body">
      <div class="chat__message">
        <div class="chat__message-list" v-for="(item, idx) in chat" :key="idx" :class="{you: $store.getters.getUserCredentials.id === item.user_id}">
          <div class="avatar">
            <img v-if="item.photo" src="#!" alt="">
      ...
      <div class="chat__form">
        <VueEditor v-model="text" :editorToolbar="customToolbar"/>
